  ...
  return (
    <section className="gallery-page">
      <div className="gallery-hero">
        ...
        <p>
          Follow the club from daily training sessions to event preparation and
          achievements. Use the filters to explore track, field, workouts, and
          milestone moments.
        </p>
      </div>
      ...
      <aside className="gallery-social-panel">
        <div>
          ...
          <p>
            More training clips, competition updates, and team highlights live
            on our platforms.
          </p>
        </div>
        <SocialLinks />
